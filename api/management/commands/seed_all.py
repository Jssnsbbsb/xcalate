...
HOMESTAYS = [
    ...
    {
        "slug": "loktak-aquamarine-floating-homestay",
        "title": "Loktak Aquamarine Floating Homestay",
        "description": "Immersive accommodation on a floating phumdi. Built entirely out of bamboo and local marsh grass following Meitei architectural styles. A rare look into water-based living on Loktak Lake.",
        "region": "loktak", "address": "Takmu, Loktak Lake, near Omba Nurathel Garden, Moirang",
        "latitude": 24.5480, "longitude": 93.7890,
        "price_per_night": 2500, "max_guests": 2, "bedrooms": 1, "beds": 1, "bathrooms": 1,
        "amenities": ["meals_included", "boat_transfer", "hot_water", "lake_view"],
        "rating": 4.9, "rating_count": 34,
    },
    {
        "slug": "laisoi-farm-homestay-loktak",
        "title": "Laisoi Farm Homestay (Floating Meitei Sangai Yumsha)",
        "description": "Eco-friendly overnight stays featuring fully organic meals sourced from the family farm, traditional folk songs performed by local fishermen, and sunrise boat tours on Loktak Lake.",
        "region": "loktak", "address": "Takmu-Pat Southern Branch, Loktak Lake",
        "latitude": 24.5440, "longitude": 93.7860,
        "price_per_night": 1800, "max_guests": 4, "bedrooms": 2, "beds": 3, "bathrooms": 1,
        "amenities": ["meals_included", "boat_transfer", "organic_farm", "cultural_shows"],
        "rating": 4.7, "rating_count": 28,
    },
    {
        "slug": "bougain-villa-cultural-homestay",
        "title": "The Bougain Villa Cultural Homestay",
        "description": "Highly-rated serene homestay offering direct immersion into local Meitei home etiquette, traditional clothing trials (Phanek & Mayek Naiba), and courtyard layout history.",
        "region": "imphal", "address": "Kwakeithel Thokchom Leikai, near Asian Hospital",
        "latitude": 24.7820, "longitude": 93.9250,
        "price_per_night": 2200, "max_guests": 3, "bedrooms": 2, "beds": 2, "bathrooms": 1,
        "amenities": ["wifi", "meals_included", "cultural_experience", "ac"],
        "rating": 4.8, "rating_count": 42,
    },
    {
        "slug": "imphal-heritage-homestay-cluster",
        "title": "Imphal Heritage Homestay Cluster",
        "description": "Family-managed cultural exchange and vernacular housing stays with home-cooked traditional meals, personalized storytelling regarding royal family lineages, and access to community activities.",
        "region": "imphal", "address": "Lane No 12, Naoremthong Khunmathem Leikai",
        "latitude": 24.7990, "longitude": 93.9280,
        "price_per_night": 1700, "max_guests": 5, "bedrooms": 2, "beds": 3, "bathrooms": 2,
        "amenities": ["wifi", "meals_included", "storytelling", "family_stay"],
        "rating": 4.6, "rating_count": 19,
    },
    {
        "slug": "wahyum-eco-bamboo-resort",
        "title": "Wahyum Eco-Bamboo Resort Cottages",
        "description": "Boutique sustainable tourism featuring premium A-frame structural cottages engineered entirely out of indigenous Manipuri bamboo species. Ideal for high-comfort eco-tourists.",
        "region": "imphal", "address": "The Shining Farmhouse Enclave",
        "latitude": 24.8090, "longitude": 93.9210,
        "price_per_night": 3500, "max_guests": 3, "bedrooms": 1, "beds": 1, "bathrooms": 1,
        "amenities": ["wifi", "ac", "breakfast", "eco_resort", "bamboo_cottage"],
        "rating": 4.8, "rating_count": 27,
    },
]
